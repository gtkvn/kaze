...
export default function Welcome({
  ...
  return (
    <>
      <Head title="Welcome" />
      <div
        className="flex flex-col items-center justify-center bg-[#F0E7E9] bg-center bg-cover text-[#261B23] not-italic font-normal leading-tight min-h-screen text-center"
        style={{
          backgroundImage:
      ...
      >
        ...
        >
          <a
            className="bg-[#D30001] hover:bg-[#261B23] flex rounded-full"
          ...
          >
            <img
              className="h-auto max-w-full w-full cursor-pointer"
              alt=""
        ...
        <ul className="bottom-0 left-0 list-none mx-8 mt-0 mb-8 right-0 absolute">
          <li>
            <strong>Rails version:</strong> {railsVersion}
          </li>
          <li>
            <strong>Ruby version:</strong> {rubyVersion}
          </li>
        </ul>
      </div>
    </>
